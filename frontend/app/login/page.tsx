...
export default function LoginPage() {
  ...
  return <main className="auth-page"><header className="auth-header"><Link href="/login" aria-label="Atanes"><Image src="/assets/atanes_logo.svg" alt="Atanes" width={2037} height={772} className="wordmark" preload/></Link><nav><Link href="/registro" className="join-link">Unirse ahora</Link><span className="active-auth">Iniciar sesión</span></nav></header>
