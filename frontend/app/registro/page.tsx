...
export default function RegisterPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    setBusy(true);
    try {
      await usersApi.create({ ...data, ciudad: selectedCity });
