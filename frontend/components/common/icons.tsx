...
export function Icon({ name, ...props }: SVGProps<SVGSVGElement> & { name: "home" | "network" | "jobs" | "bell" | "search" | "user" | "business" | "image" | "video" | "write" | "like" | "send" | "edit" | "trash" | "more" | "briefcase" | "location" }) {
