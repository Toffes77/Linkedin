...
export type ApplicationApplicant = { id: number; nombre: string; foto_perfil_url: string | null };
export type Application = { id: number; oferta_id: number; oferta_titulo: string; usuario_id: number; postulante: ApplicationApplicant; fecha: string; estado: ApplicationStatus };
...
export type MessageContact = { usuario_id: number; nombre: string; headline: string; foto_perfil_url: string | null; conversacion_id: number | null; ultimo_mensaje: string | null; ultimo_mensaje_autor_id: number | null; fecha_ultimo_mensaje: string | null; no_leidos: number; conectados: boolean };
...
export const connectionsApi = {
  ...
  remove: (userId: number) => apiFetch<void>(`/api/conexiones/${userId}`, { method: "DELETE" }),
